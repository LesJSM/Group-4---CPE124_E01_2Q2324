...
def update_metadata(input_folder, output_folder):
    ...
    for i in range(1, 187):  # change  this to the number of files in your folder + 1
...
if __name__ == "__main__":
    input_folder = "D:\\School Files\\CpE\\4Q2\\CPE124\\TTS\\wav_outputs"  # your path
    output_folder = "D:\\School Files\\CpE\\4Q2\\CPE124\\TTS\\wav_second_output"  # your path
